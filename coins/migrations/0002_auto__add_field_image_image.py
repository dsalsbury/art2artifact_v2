...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'coins_image', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='static/coins/images/default_coin_image.jpeg', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.image'
        db.delete_column(u'coins_image', 'image')
