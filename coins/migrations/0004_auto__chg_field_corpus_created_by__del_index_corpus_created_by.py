...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Corpus.created_by' to match new field type.
        db.rename_column(u'coins_corpus', 'created_by_id', 'created_by')
        # Changing field 'Corpus.created_by'
        db.alter_column(u'coins_corpus', 'created_by', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        # Removing index on 'Corpus', fields ['created_by']
        db.delete_index(u'coins_corpus', ['created_by_id'])


    def backwards(self, orm):
        # Adding index on 'Corpus', fields ['created_by']
        db.create_index(u'coins_corpus', ['created_by_id'])


        # Renaming column for 'Corpus.created_by' to match new field type.
        db.rename_column(u'coins_corpus', 'created_by', 'created_by_id')
        # Changing field 'Corpus.created_by'
        db.alter_column(u'coins_corpus', 'created_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coins.User']))
    ...
    models = {
        ...
        u'coins.image': {
            ...
            'coin': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['coins.Coin']", 'null': 'True', 'blank': 'True'}),
            'corpus': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['coins.Corpus']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
